========================================================================
    STATIC LIBRARY : LibRichEdit50 Project Overview
========================================================================

AppWizard has created this LibRichEdit50 library project for you. 

This file contains a summary of what you will find in each of the files that
make up your LibRichEdit50 application.


LibRichEdit50.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    named LibRichEdit50.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "LibRichEdit50.rc" and a "LibRichEdit50.h" that 
